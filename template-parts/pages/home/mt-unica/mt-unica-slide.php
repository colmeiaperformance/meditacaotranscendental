  ...
  <div id="mt-unica-slide" class="swiper unicaSwiper">
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <img loading="lazy"  src=<?php echo get_template_directory_uri() . '/images/mt-unica/slide1.jpg' ?> alt="Vídeo" width="100%" height="100%" class="img-1 bd-placeholder-img">
        <div class="container">
          <div class="row">
      ...
      <div class="swiper-slide">
        <img loading="lazy"  src=<?php echo get_template_directory_uri() . '/images/mt-unica/slide2.jpg' ?> alt="Vídeo" width="100%" height="100%" class=" img-2 bd-placeholder-img">
        <div class="container">
          <div class="row">
            <div class="col-6 carousel-caption text-start">
      ...
      <div class="swiper-slide">
        <img loading="lazy"  src=<?php echo get_template_directory_uri() . '/images/mt-unica/slide3.jpg' ?> alt="Vídeo" width="100%" height="100%" class="img-3 bd-placeholder-img">
        <div class="container">
          <div class="row">
            <div class="col-6 carousel-caption text-start">
      ...
      <div class="swiper-slide">
        <img loading="lazy"  src=<?php echo get_template_directory_uri() . '/images/mt-unica/slide4.jpg' ?> alt="Vídeo" width="100%" height="100%" class="img-4 bd-placeholder-img">
        <div class="container">
          <div class="row">
            <div class="col-6 carousel-caption text-start">
       ...
       <div class="swiper-slide">
        <img loading="lazy"  src=<?php echo get_template_directory_uri() . '/images/mt-unica/slide5.jpg' ?> alt="Vídeo" width="100%" height="100%" class="img-5 bd-placeholder-img">
        <div class="container">
          <div class="row">
            <div class="col-6 carousel-caption text-start">
      ...
      <div class="swiper-slide">
        <img loading="lazy"  src=<?php echo get_template_directory_uri() . '/images/mt-unica/slide6.jpg' ?> alt="Vídeo" width="100%" height="100%" class="img-6 bd-placeholder-img">
        <div class="container">
          <div class="row">
            <div class="col-6 carousel-caption text-start">
