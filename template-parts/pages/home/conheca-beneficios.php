        ...
        <div class="box rounded-circle text-center">
          <div class="default">
           ...
           <div class="hover">
            ...
            <a href="<?php echo home_url( '/beneficios/saude-mental/' ); ?>" class="btn">
              + Saiba mais
            </a>
          </div>
        </div>
         ...
         <div class="box rounded-circle text-center">
          <div class="default">
           ...
           <div class="hover">
            ...
            <a href="<?php echo home_url( '/beneficios/saude-fisica/' ); ?>" class="btn">
              + Saiba mais
            </a>
          </div>
        </div>
      ...
      <div class="col-12 col-lg-3 d-flex align-items-center justify-content-center p-0">
         <div class="box rounded-circle text-center">
          ...
          <div class="hover">
            ...
            <a href="<?php echo home_url( '/beneficios/equilibrio-emocional/' ); ?>" class="btn">
              + Saiba mais
            </a>
          </div>
        </div>
      ...
      <div class="col-12 col-lg-3 d-flex align-items-center justify-content-center p-0">
         <div class="box box-last rounded-circle text-center">
          <div class="default">
            ...
            <a href="<?php echo home_url( '/beneficios/potencial-mental' ); ?>" class="btn">
              + Saiba mais
            </a>
          </div>
        </div>
