<div class="newsletter text-white text-center">
 ...
 #_form_12_ ._full_width { width: 49%; display: inline-block; padding-right: 0px; }
 ...
 #_form_12_ button[type="submit"] { font-size:1.2em; }
 #_form_12_ ._inline-style { margin:20px 0 0 !important; }
 }
 #_form_12_ { position:relative; text-align:left; margin:25px auto 0; padding:20px; -webkit-box-sizing:border-box; -moz-box-sizing:border-box; box-sizing:border-box; *zoom:1; background:#ffc536 !important; border:0px solid #b0b0b0 !important; max-width:500px; color:#fff !important; }
 ...
 #_form_12_ ._button-wrapper  { text-align: center;}
 ...
 #_form_12_ ._x42449721 ._form-title { text-align:center; }
 #_form_12_ ._x53803252 { text-align:center; }
 #_form_12_ ._x53581023 { position:absolute; bottom:0px; padding-right:32px; text-align:center; }
 #_form_12_._form_12 { height:260px; }
 #_form_12_ ._x93779822 input { border:none; border-radius:0; }
 #_form_12_ ._x01897230 input { border:none; border-radius:0; }
 #_form_12_ ._x54268438 input { border:none; border-radius:0; }
</style>
<link href="https://fonts.googleapis.com/css2?family=Lato&family=Montserrat&family=Roboto&family=IBM+Plex+Sans:wght@400;600&display=swap" rel="stylesheet">
  <form method="POST" action="https://meditacaotranscedental.activehosted.com/proc.php" id="_form_12_" class="_form _form_12 _inline-form  _dark" novalidate>
    ...
    <input type="hidden" name="or" value="bb7907979ab23f4ee59e0f60e6cacc52" />
    <div class="_form-content">
      <div class="_form_element _x42449721 _full_width _clear" >
      ...
      <div class="_form_element _x93779822 _full_width ">
      ...
      <div class="_form_element _x01897230 _full_width " >
      ...
      <div class="_form_element _x54268438" >
