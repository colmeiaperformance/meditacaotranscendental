<section class="mt-unica-slide">
  <div id="mt-unica-slide" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img loading="lazy" src=<?php echo get_template_directory_uri() . '/images/mt-unica/slide1.png' ?> alt="Vídeo" width="100%" height="100%" class="bd-placeholder-img">
        <div class="container">
          <div class="row">
            <div class="col-6 carousel-caption text-start">
              ...
              <a class="btn" href="#">Participe da palestra gratuita</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <img loading="lazy" src=<?php echo get_template_directory_uri() . '/images/mt-unica/slide2.png' ?> alt="Vídeo" width="100%" height="100%" class="bd-placeholder-img">
        <div class="container">
          <div class="row">
            <div class="col-6 carousel-caption text-start">
      ...
      <div class="carousel-item">
        <img loading="lazy" src=<?php echo get_template_directory_uri() . '/images/mt-unica/slide3.png' ?> alt="Vídeo" width="100%" height="100%" class="bd-placeholder-img">
        <div class="container">
          <div class="row">
            <div class="col-6 carousel-caption text-start">
      ...
      <div class="carousel-item">
        <img loading="lazy" src=<?php echo get_template_directory_uri() . '/images/mt-unica/slide4.png' ?> alt="Vídeo" width="100%" height="100%" class="bd-placeholder-img">
        <div class="container">
          <div class="row">
            <div class="col-6 carousel-caption text-start">
       ...
       <div class="carousel-item">
        <img loading="lazy" src=<?php echo get_template_directory_uri() . '/images/mt-unica/slide5.png' ?> alt="Vídeo" width="100%" height="100%" class="bd-placeholder-img">
        <div class="container">
          <div class="row">
            <div class="col-6 carousel-caption text-start">
      ...
      <div class="carousel-item">
        <img loading="lazy" src=<?php echo get_template_directory_uri() . '/images/mt-unica/slide6.png' ?> alt="Vídeo" width="100%" height="100%" class="bd-placeholder-img">
        <div class="container">
          <div class="row">
            <div class="col-6 carousel-caption text-start">
  ...
  <a class="btn btn-mobile" href="#">Participe da palestra gratuita</a>
</section>