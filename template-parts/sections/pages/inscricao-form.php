  ...
  <div class="_form-content">
    <div class="row">
      <div class="col-12 col-lg-7 pe-lg-5">
        ...
        <div class="_form_element _x59911454 _full_width " >
      ...
      <div class="_form_element _x37072773 _full_width " >
        ...
        <div class="_field-wrapper">
          <input type="text" id="email" name="email" placeholder="email@dominio.com" required/>
        </div>
      </div>
      <div class="_form_element _x82386797 _full_width " >
      ...
      <div class="_form_element _x38804257 _full_width " >
        <label for="field[73]" class="_form-label">
          Data instrucao pessoal*
        </label>
        <div class="_field-wrapper">
          <input type="date" class="date_field" id="field[73]" name="field[73]" value="" placeholder="" required />
        </div>
      </div>
...
window.cfields = {"71":"data_de_nascimento","55":"profissao","2":"estado","60":"cidade","66":"instrutorinscricaocurso","73":"data_instrucao_pessoal","74":"valor_do_curso_fechado_com_o_seu_instrutor","69":"formadepagamento","75":"optin"};
