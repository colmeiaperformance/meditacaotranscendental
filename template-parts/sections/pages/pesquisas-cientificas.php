<section class="pesquisas">
    <div class="container">
      ...
      <div class="row d-flex align-items-center jusitfy-content-center">
        <div class="col-12 col-lg-6 mb-4 mb-lg-0 p-lg-0 pe-lg-5 d-flex">
          <div class="row d-flex align-items-center justify-content-center">
            <div class="col-6 d-flex align-items-center justify-content-start ps-2 pe-2">
              <img loading="lazy" class="img-fluid"
                src=<?php echo get_template_directory_uri() . '/images/o-que-e-mt/harvard.png' ?> alt="Harvard">
            </div>
            <div class="col-6 d-flex align-items-center justify-content-start ps-2 pe-2">
              <img loading="lazy" class="img-fluid"
                src=<?php echo get_template_directory_uri() . '/images/o-que-e-mt/yale.png' ?> alt="Yale">
            </div>
            <div class="col-6 d-flex align-items-center justify-content-start ps-2 pe-2">
              <img loading="lazy" class="img-fluid"
