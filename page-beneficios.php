      ...
      <div class="row align-items-center justify-content-center px-5 bloco-1">
        ...
        <div class="legend">
          ...
          <p>Com a prática da MT, conseguimos reduzir, de forma natural, os quadros de estresse e ansiedade e,
            ...
            pânico,
            transtornos de déficit de atenção e estresse pós-traumático, dentre outros.
          </p>
        </div>
    </div>
          ...
          <div class="swiper-mobile">
            <div class="container px-5">
              <div class="row d-flex align-items-center justify-content-center px-5">
                ...
                <div class="col-12 col-lg-7 d-flex align-items-center justify-content-end p-0">
                  <img loading="lazy" class="img-fluid"
